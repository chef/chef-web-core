...
})(jQuery, window, window.document);//(=) require foundation/foundation
...
})(jQuery, window, window.document);//(=) require ../chef
...
})(jQuery, window);//(=) require_tree ./chef/components
;
